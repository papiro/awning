...
module.exports = class HttpServer extends http.Server {
  constructor ({ name = '', port = 8080, root = '/', middleware = [], async = false, api = [] }) {
    super()

    const middlewareEngine = async ? middleware_async : middleware_plain
    ...
    this.on('request', (req, res) => {
      ...
      middlewareEngine(middleware, req, res)
    })
