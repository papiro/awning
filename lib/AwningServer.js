...
Object.addMethod(http.ServerResponse.prototype, 'publish', (status, message, headers) => {
  this.setStatus(status)
  this.writeJSON(message)
})
Object.addMethod(http.ServerResponse.prototype, 'setStatus', (statusCode) => {
  this.statusCode = statusCode
})
Object.addMethod(http.ServerResponse.prototype, 'setHeaders', (obj) => {
  Object.keys(obj).forEach( key => {
    this.setHeader(key, obj[key])
  })
})
Object.addMethod(http.ServerResponse.prototype, 'writeJSON', (obj) => {
