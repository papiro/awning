...
module.exports = class AwningStore extends EventEmitter {
  constructor ({ file, frequency = _frequency } = {}) {
    super()

    if (arguments.length === 1 && arguments[0] instanceof Object === false) {
      // Assume the sole argument was a file name, as this is the most popular use-case.
